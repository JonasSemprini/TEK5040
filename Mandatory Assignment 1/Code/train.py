...
def main(train_dir):
    ...
    def train_step(image, y):
        ...
        check = metric_fn(y, y_pred)
        train_loss.update_state(loss)
        train_accuracy.update_state(check)
    ...
    def val_step(image, y):
        ...
        y_pred = model(image)
        loss_pred = loss_fn(y, y_pred)
        
        check = metric_fn(y, y_pred)
        
        val_loss.update_state(loss_pred)
        val_accuracy.update_state(check)
...
if __name__ == '__main__':
    ...
    #Start loss unet: 0.663578
    #End loss unet: 0.0782955
    #Best loss unet: 0.0574652 Epoch 12 Step 750
    
    #Start loss simple: 0.582806
    #End loss unet: 0.189544
    #Best loss simple: 0.142875 Epoch 12 Step 750
    
    # Total params: 436,857
    # Trainable params: 436,857